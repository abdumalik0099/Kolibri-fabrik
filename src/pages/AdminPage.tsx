...
export default function AdminPage() {
  ...
  useEffect(() => {
    console.log("[AdminPage] products", products);
  }, [products]);
                  ...
                  <motion.div key={p.id} layout initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="bg-charcoal-light border border-gold/10 rounded-xl overflow-hidden group">
                    <div className="relative aspect-square overflow-hidden">
                      {videoSrc ? (
                        ...
                        <img src={logoPlaceholder} alt="Placeholder" loading="lazy" decoding="async" className="w-full h-full object-contain p-8 opacity-60 bg-charcoal/70" />
                      )}
                    </div>
                    <div className="p-4">
