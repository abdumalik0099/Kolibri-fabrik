...
import { getProductImageUrl, getProducts, getProductVideoUrl, Product } from "../lib/products";
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <h1 className="font-heading text-4xl md:text-6xl mt-3 font-light">
              Bizning{" "}
              <span className="text-gold-gradient font-semibold italic">katalog</span>
            </h1>
          </motion.div>
          ...
          >
            ...
            {categories.map((cat) => (
              ...
              >
                {/* ✅ Kategoriya rasmi yuklanmasa logoPlaceholder ishlatiladi */}
                <img
                  src={cat.imageUrl}
                  alt={cat.name}
          ...
          {loading ? (
            ...
            <div className="text-center py-20">
              ...
              <p className="text-sm text-muted-foreground/60 mt-2">
                Admin panelidan mahsulot qo'shing.
              </p>
            </div>
          ) : (
                  ...
                  >
                    <Link to={`/mahsulot/${product.id}`} className="group block">
                      <div className="relative overflow-hidden rounded-xl aspect-[3/4] bg-muted">
                        {videoSrc ? (
                          ...
                          <img
                            ...
                            alt={product.title}
                            loading="lazy"
                            // ✅ Rasm yuklanmasa logoPlaceholder ishlatiladi
                            onError={(e) => {
                              e.currentTarget.src = logoPlaceholder;
                            }}
                          ...
                          // ✅ imageUrl yo'q bo'lsa ham logoPlaceholder ko'rsatiladi
                          <img
                            src={logoPlaceholder}
                            alt="Placeholder"
                            loading="lazy"
                            className="w-full h-full object-contain p-8 opacity-60 bg-charcoal/70"
                          />
                        )}
                      ...
                      <div className="mt-3">
                        ...
                        <h3 className="font-heading text-base md:text-lg font-semibold mt-1 leading-tight">
                          {product.title}
                        </h3>
                      </div>
                    </Link>
